import type { TeamData, TeamKey } from '$lib/types';

const notfound: TeamData = {
	key: 'notfound',
	name: 'Bot Not Found',
	number: '23404',
	...
	heroImage: '/robots/redshift.png',
	heroImageAlt: 'Redshift, the 23404 DECODE robot',
...
const found: TeamData = {
	key: 'found',
	name: 'Bot Got Found',
	number: '32954',
	eyebrow: 'Founded 2025 · FIRST Tech Challenge',
	heroLine: 'We started as',
	heroEm: 'the overflow.',
	intro:
		'In September 2025 more students joined than 23404 could seat. Returning members stayed there. The rest of us started this team. Signups ran late, so we began after the season had already started, with no experience and almost no parts. We wrote down our values in this order: creativity, simplicity, versatility, inclusion, honesty.',
	heroImage: '/robots/bot-32954.png',
	heroImageAlt: 'Bot Got Found 32954 competition robot',
	motto: ['Consistency', 'Over', 'Complexity'],
	specs: [
		{ k: 'Season', v: '2025–26 · DECODE' },
		{ k: 'Robot', v: 'Starter bot, three revisions' },
		{ k: 'Roster', v: '4 · build, CAD, programming, drive' },
		{ k: 'Best finish', v: 'Playoffs · Feynman Interleague' },
		{ k: 'First sponsor', v: 'Argosy Foundation' }
	],
	photoSlot: 'team photo, rookie roster',
	photoCaption: 'The team, 2025–26',
	missionBig:
		'Our mission is to promote an inclusive environment that welcomes people of all skill levels. In our first year, many team members were new to robotics, yet we faced every challenge with determination and demonstrated our passion in competition. With no formal entry requirements, we offer an open space for anyone interested in robotics, regardless of their experience.',
	missionAttr: 'DECODE portfolio, 2026',
	missionTail:
		'Most of us had never done robotics. We learned programming, CAD, and driving inside the season, asking 23404 and a rival team when we got stuck.',
	pillars: [
		{
			n: '01',
			title: 'Objective-oriented analysis',
			body: 'Every scoring objective ranked by points, consistency, and time. Three-artifact cycles won for teleop, preloaded shots for auto.'
		},
		{
			n: '02',
			title: 'Reliability first',
			body: 'Reliability mattered more than mechanism count. Simple intake, simple shooter, fast alignment at the player station.'
		},
		{
			n: '03',
			title: 'Identify, adjust, test',
			body: 'Find the weakness, change it, test, repeat. Three versions of the robot in one season.'
		}
	],
	historyTitle: 'One season, in progress',
	historyIntro: 'Our first year as it happened. The parts that failed are here too.',
	seasons: [
		{
			years: '2025–26',
			tag: 'Rookie season',
			game: 'DECODE',
			body: 'We formed in September from students the club could not seat. 23404 held most of the parts and all the experience. We built the goBILDA starter bot, modified it until it passed inspection, and rebuilt it twice after that.',
			log: [
				{
					k: 'LM1',
					v: 'Starter bot, tournament-legal. Crash Out pushed us around the field and we lost. The launcher fired when it felt like it.'
				},
				{ k: 'Diagnosis', v: 'Vibration was loosening the ramp screws, so the robot shot up instead of forward.' },
				{
					k: 'LM2',
					v: 'Added mecanum wheels, more motors, more mass, and basic protection. Lock-tightened the screws and added zip ties to raise the ramp angle.'
				},
				{
					k: 'Interleague',
					v: 'Added a proper intake with both human feed and ground collection. Split the controls between a driver and a shooter.'
				},
				{
					k: 'Autonomous',
					v: 'Move to the goal, fire three preloaded artifacts, return to base. The original robot could only shoot artifacts handed to it, which limited what auto could do.'
				},
				{
					k: 'Drivetrain',
					v: 'Mecanum wheels with the motors mounted close in to keep speed and torque. Field-centric driving came in before LM2 and improved accuracy without moving us up the rankings.'
				},
				{
					k: 'Shooter',
					v: 'Angled to clear the goal without breaking the height limit. Fed from storage by an intake ramp.'
				},
				{
					k: 'Battery',
					v: 'The holder was designed to take both the new and the old battery types so the robot is never waiting on a charge.'
				},
				{ k: 'Result', v: 'Reached playoffs at Feynman Interleague in our first season.' }
			],
			photo: '2026 robot, interleague',
			fig: 'Intake and shooter'
		}
	],
	sponsorTitle: 'Our first sponsor changed what we could build',
	sponsorIntro:
		'23404 owned the parts bin and used most of it. We bought basics with club funds until our first sponsors signed on. Your name rides on the robot to every event, and goes on the pit banner, the jerseys, and this page.',
	sponsors: [
		{
			tier: 'gold',
			name: 'Argosy Foundation',
			note: 'The FTC SIM Argosy rookie team grant, $1,000 toward our first season.',
			url: 'https://www.theargosyfoundation.org'
		},
		{
			tier: 'silver',
			logo: '/sponsors/microsoft.png',
	...
	partners: [
		{ name: 'Bot Not Found 23404', note: 'Sister team, shared shop' },
		{ name: 'Crash Out 23405', note: 'Advice and scrimmages' },
		{ name: 'Redmond High Robotics', note: 'Home club' }
	],
	sponsorPitch: 'For a rookie team, the first sponsor buys time.',
	sponsorPitchTail:
		'With parts on hand we fix the robot this week instead of waiting for the next meet to see whether the workaround holds. We reached playoffs on a modified starter bot. Our next robot does not have to start there.'
};

export const teams: Record<TeamKey, TeamData> = { notfound, found };

export function siblingOf(team: TeamKey): TeamKey {
	return team === 'notfound' ? 'found' : 'notfound';
}
